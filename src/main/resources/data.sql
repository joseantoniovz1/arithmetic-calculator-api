INSERT INTO users (id, email, password, status) VALUES (1, 'michael@scott.com', 'michael', 'active');
INSERT INTO users (id, email, password, status) VALUES (2, 'dwight@schrute.com', 'dwight', 'inactive');
INSERT INTO users (id, email, password, status) VALUES (3, 'pam@beasley.com', 'pam', 'active');
INSERT INTO users (id, email, password, status) VALUES (4, 'jim@halpert.com', 'jim', 'inactive');
...
INSERT INTO record (operation_id, user_id, amount, user_balance, date) VALUES (4, 1, 10.10, 5.5, current_date);
